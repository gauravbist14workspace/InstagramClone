...
public class UniversalImageLoader {
    ...
    /**
     * this method can used to set images that are static . Though it cant be used
     * if the images are being changed in the fragment/activity OR if they are set
     ...
     * @param append
     */
    public static void setImage(String imageURL, ImageView image, final ProgressBar mProgrssBar, String append) {
